...
export class DeleteLeaf extends React.Component {
    render() {
        return (
            <Modal isOpen={this.props.show} toggle={this.toggleDelete}>
                <ModalHeader toggle={this.toggleDelete}>Disconnect Leaf</ModalHeader>
                <ModalBody>
                ...
                <ModalFooter>
                    <Button color="danger" onClick={() => this.props.deleteLeaf(this.props.uuid)}>Yes</Button>{' '}
                    <Button color="secondary" onClick={this.toggleDelete}>No</Button>
                </ModalFooter>
            </Modal>);
    }
}
